...
const Loading = () => {
  ...
  <div className="absolute top-4 h-5 w-4 animate-bounce border-l-2 border-gray-200" style={{rotate: '-90deg'}} />
  <div className="absolute top-4 h-5 w-4 animate-bounce border-r-2 border-gray-200" style={{rotate: '90deg'}} />
</div>
